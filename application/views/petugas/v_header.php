...
<head>
    ...
    <title>Header petugas-SI Perpustakaan</title>
    <!-- css bootstrap -->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a href="<?php echo base_url('petugas'); ?>" class="nav-link"><i class="fa fa-home mr-2"></i>Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url('petugas/petugas'); ?>" class="nav-link"><i class="fa fa-user mr-2"></i>Petugas</a>
                </li>
                <li class="nav-item">
